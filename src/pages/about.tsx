    ...
    <>
      ...
      <main className="font-josefin-sans">
        ...
        <div className="bg-white">
          {/* Vision */}
          <div className="flex gap-x-32 justify-between items-center lg:mx-40 py-18">
            <div className="basis-4/12 w-96">
              <div className="flex flex-col gap-y-4 w-96 py-8">
                <h2 className="text-6xl font-medium text-black">Our Vision</h2>
          ...
          <div className="flex gap-x-32 justify-between items-center lg:mx-40 py-18">
            ...
            <div className="basis-4/12 w-96">
              <div className="flex flex-col gap-y-4 w-96 py-8">
                <h2 className="text-6xl font-medium text-black">Our Mission</h2>
                <p className="text-warm-grey font-2xl">
          ...
          {/* Core Values */}
          <div className="flex gap-x-32 justify-between items-start lg:mx-40 py-20">
            <div className="basis-4/12">
              <div className="flex flex-col gap-y-8 w-96">
                <h2 className="text-6xl font-medium text-black">Core Values</h2>
                <p className="text-warm-grey font-2xl">
            ...
            <div className="basis-7/12 flex flex-col">
              ...
              <div className="flex flex-col gap-6 border-b-0.5 border-light px-7 py-8">
                <div className="flex flex-col gap-2.5">
                  <h3 className="font-bold text-black text-4xl">Compassion</h3>
                  <h4 className="font-semibold text-dark text-2xl">
